...
setup = TS.build_setup(; λ0, τfwhm, energy, thickness, material,
                         mask_diam, mask_spacing, λlims=(110e-9, 600e-9),
                         beam, window)

τi = 0e-15
out2_tanh = simulate_delay_point(setup, τi; nz=11, init_dz=1e-7, filename="check2_tanh.h5")
